...
title: 知乎卡片式链接
author: Tamsiree
date: 2020-06-07 12:13:38
description: 模仿知乎的卡片式链接。
tags:
  - TechnicalResearch
  - Hexo
categories:
  - TechnicalResearch
  - Hexo
cover: https://cdn.jsdelivr.net/gh/Tamsiree/Assets@master/Picture/Blog/Cover/wallls.com_220521.png
---
# 正文
...
这是一种后加载，创建`linkcard.js`放到`source/js/src/`，然后在`themes\xxx\layout\post.pug`中引用
...
```
<a href="https://tamsiree.com/" target="_blank" class="LinkCard">Tamsiree 博客</a>
```
